...
const Chatbot = () => {
    const [messages, setMessages] = useState([
        {
            id: 1,
            type: 'bot',
            content: "Hello! I'm your personal CA Assistant. I can help you analyze your expenses, provide financial advice, and answer questions about your spending patterns. How can I assist you today?",
            timestamp: new Date()
        }
    ]);
    ...
    const generateResponse = (userMessage) => {
        ...
        if (lowerMessage.includes('advice') || lowerMessage.includes('tips') || lowerMessage.includes('suggest')) {
                ...
                <div className="bg-[#161b22] p-4 rounded-lg border border-[#30363d]">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-[#8b949e] text-sm">Get detailed spending insights</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-[#161b22] p-4 rounded-lg border border-[#30363d]">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-[#8b949e] text-sm">Personalized financial tips</p>
                        </div>
                    </div>
                </div>
